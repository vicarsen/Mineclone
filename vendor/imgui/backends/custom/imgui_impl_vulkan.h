...
#include <volk.h>
#else
#include <glad/vulkan.h> // Changed from <vulkan/vulkan.h>
#endif
...
struct ImGui_ImplVulkan_InitInfo {
	...
	VkDeviceSize
		MinAllocationSize; // Minimum allocation size. Set to 1024*1024 to satisfy zealous best practices validation layer and waste a little memory.
};
...
struct ImGui_ImplVulkanH_Window {
	...
	ImGui_ImplVulkanH_Window()
	{
		...
		PresentMode =
			(VkPresentModeKHR)~0; // Ensure we get an error if user doesn't set this.
		ClearEnable = true;
	}
};
